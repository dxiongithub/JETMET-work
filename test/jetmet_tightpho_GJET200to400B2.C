...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    TFile *JETMETPuppi = new TFile("jetmet_tightpho_GJET200to400B2.root", "RECREATE");
    ...
    */
    ...
    cout << "Start analysis on jetmet_tightpho_GJET200to400B2.C " << endl;
    ...
    cout << "output root file: " << "jetmet_tightpho_GJET200to400B2.root" << endl;
