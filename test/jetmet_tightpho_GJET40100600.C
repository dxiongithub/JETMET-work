...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    TFile *JETMETPuppi = new TFile("jetmet_tightpho_GJET40100600.root", "RECREATE");
    ...
    */
    ...
    cout << "Start analysis on jetmet_tightpho_GJET40100600.C " << endl;
    ...
    cout << "output root file: " << "jetmet_tightpho_GJET40100600.root" << endl;
