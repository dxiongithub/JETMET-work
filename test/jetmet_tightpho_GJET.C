...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    TFile *JETMETPuppi = new TFile("jetmet_tightpho_GJET.root", "RECREATE");
    ...
    */
    ...
    cout << "Start analysis on jetmet_tightpho_GJET.C " << endl;
    ...
    cout << "output root file: " << "jetmet_tightpho_GJET.root" << endl;
