//modified on Mar. 11, 2020 for getting the AK4Puppi


//adding rawmet info on 05.20.2020

//adding photon ID for Puppi tune v14 on 07.02.2020
...
class ggNtuplizer : public edm::EDAnalyzer {
 ...
 private:
  ...
  //rawmet//
  //edm::EDGetTokenT<edm::View<pat::MET> >           rawMETlabel_;

  //metspuppi//
  edm::EDGetTokenT<edm::View<pat::MET> >           metsPUPPI_;
  //
  ...
  //adding ak4puppi
  edm::EDGetTokenT<edm::View<pat::Jet> >           jetsAK4PuppiLabel_;
  /////////////////
