//this version is for JETMET service work
//edited by De-Lin Macive Xiong, Florida State University, 8.12.2019

//modified log
//adding AK4Puppi on 03.11.2020

//adding rawmet info on 05.20.2020
  ...
  hltPrescaleProvider_(ps, consumesCollector(), *this)
{
  ...
  //metpuppi//
  metsPUPPI_		         = consumes<View<pat::MET> >               (ps.getParameter<InputTag>("metsPUPPI"));
  ///////////
  //RAWMET//
  //rawMETlabel_		         = consumes<View<pat::MET::Raw> >           (ps.getParameter<InputTag>("rawMETLabel"));
  ...
  //adding ak4puppi
  jetsAK4PuppiLabel_         = consumes<View<pat::Jet> >               (ps.getParameter<InputTag>("puppiAK4"));
  /////////////////
